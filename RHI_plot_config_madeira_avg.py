...
when_start = dt.datetime.strptime('2021-05-19', '%Y-%m-%d')
when_end= dt.datetime.strptime('2021-12-31', '%Y-%m-%d')
...
scan_dict = {35:{'res': 25, 'acct':1000, 'disp': 5, 'theo':1.0},
             ...
             137:{'res': 50, 'acct':1000, 'disp': 50, 'theo':1.0},
             }
...
where_lid = r"X:\Madeira data\LPMA\RHI_windgust_2021"
name_lid_pre = 'WLS100s-191_'
name_lid_post = '*_rhi_' + str(scan_ID) + '_50m.nc'
dt_lid_format = '%Y-%m-%d'

# output directory
outstr = r"X:\Madeira data\LPMA\RHI_output\2021windgust_avg_2000"
